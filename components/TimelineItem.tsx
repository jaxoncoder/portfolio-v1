...
export function TimelineItem({
  ...
  return (
    <>
      <article className="relative grid md:grid-cols-6 md:gap-10 before:content-[''] mx-6 before:block before:h-full before:absolute before:left-[-25px] md:before:left-[-37px] before:border-l-2 before:border-gray-300 dark:before:border-gray-700 md:space-x-4 pt-2 text-justify">
